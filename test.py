...
def model(theta_flat, phi0,phi1, phi2, phi3, phi4, phi5, A):
...
initial_guess = [25, 5, 5, 5, 5, 5, 200]  # Adjust if necessary
...
phi0_opt, phi1_opt, phi2_opt, phi3_opt, phi4_opt, phi5_opt, A_opt = params
# phi0_opt, phi1_opt, phi2_opt, phi3_opt, phi4_opt, phi5_opt = params
...
# setup para ver tudo alinhado e intensidade maxima:
print(f"Setup para varrimento com intensidade maxima:\n{phi0_opt-phi1_opt+180}\n{phi0_opt-phi2_opt+180}\n{phi0_opt-phi3_opt+180}\n{phi0_opt-phi4_opt+180}\n{phi0_opt-phi5_opt+180}")